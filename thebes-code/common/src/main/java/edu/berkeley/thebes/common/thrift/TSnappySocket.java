 ...
 *
 */
public class TSnappySocket extends TIOStreamTransport {
   ...
   */
  public TSnappySocket(Socket socket) throws TTransportException {
    socket_ = socket;
    try {
   ...
   */
  public TSnappySocket(String host, int port) {
    this(host, port, 0);
  }
   ...
   */
  public TSnappySocket(String host, int port, int timeout) {
    host_ = host;
    port_ = port;
    timeout_ = timeout;
    initSocket();
