...
greater in our Technical Report~\cite{hat-tr}), which we believe to be
the most novel of our algorithms. We find that HAT properties---while
more resource-intensive than basic eventual consistency---scale well
to many servers.
