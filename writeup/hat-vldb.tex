...
Oliner, Aurojit Panda, Shivaram Venkataraman, and the HotOS and VLDB
reviewers for their helpful feedback on earlier revisions of this
work. This research was supported in part by the Air Force Office of
Scientiﬁc Research (grant FA95500810352), DARPA XData Award
FA8750-12-2-0331, the National Science Foundation (grants CNS-0722077,
IIS-0713661, and IIS-0803690), NSF CISE Expeditions award CCF-1139158,
the National Science Foundation Graduate Research Fellowship (grant
DGE-1106400), and by gifts from Amazon Web Services, Google, SAP,
Cisco, Clearstory Data, Cloudera, Ericsson, Facebook, FitWave, General
Electric, Hortonworks, Huawei, Intel, Microsoft, NetApp, Oracle,
