...
\begin{tikzpicture}[scale=0.8]
 ...
 \node[draw=none,fill=none] (ici) at (1.2, 1.6) {\underline{I-CI}};
 \node[draw=none,fill=none] (pci) at (1.2, 2.4) {\underline{P-CI}};
 ...
 \node[draw=none,fill=none] (wfr) at (4.9,0) {\underline{WFR}};
 \node at (6.3,0) [sticky] (ryw) {\underline{RYW}};

 \node at (3.6, 2) [sticky] (causal) {\underline{Causal}};
 \node[noha] (cs) at (2, 2.8) {CS};
 \node[noha] (rr) at (.6, 3.0) {RR};
 \node[noha] (si) at (-.4, 2.4) {SI};
 \node[noha] (cr) at (-.4, 1.2) {CR};
 \node[noha] (s) at (-.4, 3.5) {S};
