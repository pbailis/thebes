...
\end{align*}
$T_2$ can also observe $a=\bot$ or $a=1$. Notably, TA implies Read
Committed isolation: observing all effects of a transaction implicitly
requires observing the final (committed) effects of a transaction as
well.
