...
either high availability ($1$-available) or sticky high availability
($1$-sticky-available). They offer substantial latency and
availability benefits compared to traditional distributed databases,
yet they cannot achieve all the traditional semantics. In this
...
property that be offered in a highly available way.
...
prohibits Phantoms. Predict Cut Isolation is also achievable in HAT
system via similar multi-versioning as above.
...
achievable in a HAT system. We omit a full discussion of the algorithm
