...
Earth---communicating via a hypothetical link along the planet's
diameter---require a minimum 85.1ms round-trip time (RTT; 133.7ms if
sent at surface level). As services are replicated to multiple,
...
1s\footnote{Data available at
  \url{http://bailis.org/blog/communication-costs-in-real-world-networks/}}. We
...
failures, quantifying and minimizing communication delays is an active
