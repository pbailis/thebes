...
\item For correct behavior, most applications will require a
  combination of HAT and (ideally sparing use of) non-HAT isolation levels;
  future database designers should act accordingly.
\end{introenumerate}
