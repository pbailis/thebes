...
atomicity (``Monotonic Atomic View'' isolation), and many other consistency
...
can be confusing and that the subtle distinctions between them can
often appear to be primarily of academic concern. Accordingly, we
offer the following pragmatic takeaways:
