...
stores~\cite{bigtable, pnuts, dynamo}. Instrumental in this trend was
...
in the presence of network partitions~\cite{brewer-slides}. However,
...
available in the presence of partitions~\cite{ foundation-article,
  mdcc, krikellas-bargain, eiger, walter}. (TODO:ADD more)
