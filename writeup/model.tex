...
replicas. Similarly, with majority availability, at least one replica
will be present in all requests, so $1$-sticky availability is weaker
than majority availability, and, more generally, $K$-sticky
availability is weaker than $\lceil \frac{N}{2} \rceil$$+$$K$$-$$1$
availability.
